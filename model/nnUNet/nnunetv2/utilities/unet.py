...
class SAMConvUNet(nn.Module):
    def __init__(self,
        ...
        assert len(n_conv_per_stage_decoder) == (n_stages - 1), "n_conv_per_stage_decoder must have one less entries " \
                                                                ...
                                                                f"stages, so it should have {n_stages - 1} entries. " \
                                                                f"n_conv_per_stage_decoder: {n_conv_per_stage_decoder}"
        # print("SAMConvUNet info",input_channels, n_stages, features_per_stage, conv_op, kernel_sizes, strides,
        #                                 n_conv_per_stage, conv_bias, norm_op, norm_op_kwargs, dropout_op,
...
if __name__ == '__main__':
    ...
    model = PlainConvUNet(4, 4, (32, 64, 128, 256), nn.Conv2d, 3, (1, 2, 2, 2), (2, 2, 2, 2), 8,
                                (2, 2, 2), False, nn.BatchNorm2d, None, None, None, nn.ReLU, deep_supervision=True)
